...
private:
	...
	std::array<std::array<float, 3>, 16>LockerColliderOffset =
	{
	...
	std::array<std::array<float, 3>, 16>LockerColliderScale =
	{
	...
	std::array<std::array<float, 3>, 2>FrontWallColliderOffset =
	{
			-39.732f, 13.143f, 29.882f,
			-42.742f, 12.857f, -5.200f,
	};
	std::array<std::array<float, 3>, 2>FrontWallColliderScale =
	{
		2.743f, 13.029f, 1.966f,
		1.114f, 12.514f, 35.5f,
	};
	std::array<std::array<float, 3>, 7>BlackBoardColliderOffset =
	{
	...
	std::array<std::array<float, 3>, 7>BlackBoardColliderScale =
	{
	...
	std::array<std::array<float, 3>, 2>BackWallColliderOffset = 
	{
		34.661f , 13.143f, -40.686f,
		37.702f , 13.143f, -5.556f,

	};
	std::array<std::array<float, 3>, 2>BackWallColliderScale =
	{
		2.743f, 13.029f, 2.53f,
		1.371f, 12.943f, 35.5f,

	};
	std::array<std::array<float, 3>, 7>RightWallColliderOffset =
	{
	...
	std::array<std::array<float, 3>, 7>RightWallColliderScale =
	{
	...
	std::array<std::array<float, 3>, 2>LeftWallColliderOffset =
	{
		-3.3770f, 12.913f, -44.00f,
		-39.292f, 13.143f, -40.755f,

	};
	std::array<std::array<float, 3>, 2>LeftWallColliderScale =
	{
